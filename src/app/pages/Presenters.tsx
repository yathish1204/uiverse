            ...
            {uniquePresenters.map((presenter) => (
              ...
              >
                ...
                {isAdmin && (
                      <div className="absolute -top-2 -right-2 flex gap-2 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
                        ...
                        <button
                          ...
                          onClick={(e) => {
                            e.preventDefault();
                            e.stopPropagation();
                            setPendingDeleteName(presenter.name);
                  ...
                  <p className="text-[13px] sm:text-sm text-white/60 mb-1 line-clamp-1">{presenter.role}</p>
            ...
            >
              <DialogContent className="bg-[#0a0a0a]/95 backdrop-blur-xl border border-white/10 text-white max-w-lg">
                ...
                <p className="text-white/70 text-sm">
                  {pendingDeleteName ? (
                    <>
                      You’re about to delete <span className="text-white font-semibold">{pendingDeleteName}</span>.
                    </>
                  ) : (
                    "You’re about to delete this presenter."
                  )}
                </p>
                <div className="flex items-center justify-end gap-3 pt-2">
                  <Button
                  ...
                  <Button
                    ...
                    onClick={() => {
                      if (pendingDeleteName) deletePresenter(pendingDeleteName);
