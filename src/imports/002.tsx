import imgImageDesignSystemsTheFutureOfScalableUi from "figma:asset/647e26333d40edba7df7062c52b9d13369455d4c.png";
import imgPerson02 from "figma:asset/21d99a8334ed60d969c4ba2f09683192b5c494f0.png";
import imgPerson3 from "figma:asset/bf80a68d2424b33bc038d84f698c289ad24859ca.png";
...
function Container5() {
  return (
    <div className="absolute h-[14.325px] left-[456.31px] top-[11.78px] w-[30.092px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[14.327px] not-italic right-[30.19px] text-[10.029px] text-[rgba(255,255,255,0.8)] top-[-0.71px] translate-x-full whitespace-nowrap">22 min</p>
    </div>
  );
}
...
function Heading() {
  return (
    <div className="content-stretch flex h-[22.919px] items-start relative shrink-0 w-full" data-name="Heading 3">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[22.923px] min-w-px not-italic relative text-[#fefce8] text-[17.192px]">AI Agents Dymistified</p>
    </div>
  );
}
...
function Container() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-black blur-[0px] h-[346.656px] left-[calc(50%+92.68px)] top-[calc(50%-9.36px)] w-[501.534px]" data-name="Container">
      <Container1 />
    </div>
  );
}
...
function Frame() {
  return (
    <div className="bg-[red] content-stretch flex items-center justify-center px-[10px] py-[4px] relative w-[268.695px]">
      <div className="flex h-[40.896px] items-center justify-center relative shrink-0 w-[209.21px]" style={{ "--transform-inner-width": "285", "--transform-inner-height": "21" } as React.CSSProperties}>
        <div className="flex-none rotate-[-0.51deg]">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative text-[32px] text-white whitespace-nowrap">Micheal John</p>
        </div>
      </div>
    </div>
  );
...
function Presenter() {
  return (
    <div className="absolute h-[347.371px] left-0 top-[18px] w-[319.22px]" data-name="Presenter">
      <div className="absolute left-0 size-[318px] top-0" data-name="person-02">
        <img alt="" className="absolute block inset-0 max-w-none size-full" height="318" src={imgPerson02} width="318" />
      </div>
      <div className="absolute left-[2px] size-[318px] top-[2.86px]" data-name="person-02">
        <img alt="" className="absolute block inset-0 max-w-none size-full" height="318" src={imgPerson3} width="318" />
      </div>
      <div className="absolute flex h-[74.584px] items-center justify-center left-[23px] top-[292px] w-[275.58px]" style={{ "--transform-inner-width": "285", "--transform-inner-height": "21" } as React.CSSProperties}>
        <div className="-skew-x-4 flex-none rotate-[5.63deg]">
          <Frame />
        </div>
      </div>
    </div>
...
function Dates() {
  return (
    <div className="absolute content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold items-start leading-[normal] left-[799px] not-italic text-white top-[255px] w-[67.171px]" data-name="Dates">
      <p className="relative shrink-0 text-[52.925px] whitespace-nowrap">20</p>
      <p className="min-w-full relative shrink-0 text-[23.155px] w-[min-content]">APRIL</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="relative size-full" data-name="002">
      <Container />
      <Presenter />
      <Dates />
    </div>
